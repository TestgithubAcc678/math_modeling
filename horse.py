...
y_new=[]
print(len(x))
for point in points_new:  #rho=x*k0+y*k1
    if point[0]>750 and point[0]<1150 and point[1]<800 and point[1]>350:
      rho.append(10)
      x_new.append(point[0])
      y_new.append(point[1])
    elif point[0]>0 and point[0]<600 and point[1]<1400 and point[1]>750:
      rho.append(8)
      x_new.append(point[0])
      y_new.append(point[1])
    else:
...
plt.xlim([0, 1916])
plt.ylim([1450, 0])
plt.savefig('horse_skalor.png', dpi=3000)